...
const CryptoTable = () => {
  ...
  return (
    <Table className="max-w-[1340px] h-[420px] mx-auto">
      ...
      <TableBody className="space-y-2 h-full">
          ...
          >
            <TableCell className="col-span-1 h-[71px]">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col justify-between pr-1 gap-2">
                  <div className="text-nowrap pt-1 text-[16px] font-normal leading-none tracking-[-0.02em] text-right">
                    {crypto.name}
                  </div>
                  <div className="text-[#575B66] pl-0 ml-[-4px] pb-1 pt-0 text-xs leading-[21px] tracking-[-0.02em] text-right">
                    {crypto.shortName}
                  </div>
                </div>
              </div>
            ...
            <TableCell className="col-span-1 flex items-center justify-center font-readex  text-base text-white font-medium">
              {formatToDollar({ amount: crypto.currentPrice })}
            </TableCell>

            <TableCell
              className="col-span-1 flex-center text-red-500"
              style={{ direction: "ltr" }}
            >
              {crypto.hourChange}
            </TableCell>
            <TableCell
              className="col-span-1 flex-center text-green-500"
              style={{ direction: "ltr" }}
            >
              {crypto.dayChange}
            </TableCell>
            <TableCell className="col-span-1 flex-center">
              {crypto.marketCap}
            </TableCell>
            <TableCell className="col-span-1 flex-center">
